...
from estabelecimento.api.viewsets import EstabelcimentoViewSet
...
routers.register(r'api/v1/estabelecimento', EstabelcimentoViewSet, base_name='Estabelecimento')
